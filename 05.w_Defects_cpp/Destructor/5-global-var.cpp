...
{
    Test tempObject;
    return tempObject;/*Tool should detect this line as error*/ /*ERROR:Invalid memory access to already freed area*/
}
Test t = CreateInstance();
void DestructorTest_0053()
{
}
