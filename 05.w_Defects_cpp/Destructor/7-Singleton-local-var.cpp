...
void DestructorTest_0072()
{
    Singleton inst1 = *Singleton::CreateInstance();
    Singleton inst2 = *Singleton::CreateInstance();/*Tool should detect this line as error*/ /*ERROR:Invalid memory access to already freed area*/
}
