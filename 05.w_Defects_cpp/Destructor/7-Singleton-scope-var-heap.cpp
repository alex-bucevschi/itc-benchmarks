...
void DestructorTest_0071()
{
    for (int tr = 0; tr < 10; tr++)
    {
        Singleton *inst = Singleton::CreateInstance();
        delete inst;/*Tool should detect this line as error*/ /*ERROR:Invalid memory access to already freed area*/
    }
}
